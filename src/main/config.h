#define SENSOR_VALUE_MIN    595.0   // minimum value from the sensor
#define SENSOR_VALUE_MAX    919.0   // maximum value from the sensor

#define MINHUMIDITY         32      // Breakpoint on which humidity the system will react [0.65] Rage: [595 - 919]
